...
public enum EBusinessErrorCodes {
    ...
    DATA_INTEGRITY_VIOLATION(306, CONFLICT, "Data integrity violation"),
    ;
    ...
    EBusinessErrorCodes(int code, HttpStatus status, String description) {
        this.code = code;
